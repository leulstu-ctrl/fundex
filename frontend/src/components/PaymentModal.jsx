  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-white text-gray-900 rounded-xl shadow-2xl w-full max-w-md overflow-hidden relative animate-fade-in">
        ...
        {/* Header - Always visible unless success? keep it consistent */}
        ...
        {step === 'payment' && (
            <div className="flex flex-col h-full">
                {/* Timer Bar */}
                <div className="bg-blue-50 px-4 py-2 flex justify-between items-center text-sm font-medium text-blue-800">
                ...
                {/* Currency Selector */}
                <div className="flex p-2 bg-gray-50 gap-2 justify-center border-b border-gray-100">
                    <button
                ...
                <div className="p-6 flex flex-col items-center text-center">
                    ...
                    <div className="w-full bg-gray-50 rounded-lg p-3 border border-gray-200 flex items-center justify-between gap-3 mb-6">
